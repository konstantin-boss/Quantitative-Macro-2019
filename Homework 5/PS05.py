...
### to fully describe the distribution. We know that E[s] = 1 and hence E[z] = E[s^(1-gamma)]=1 as well, since the exponent is
### just a constant transformation. Moreover, we have E[k] = 1 given.
