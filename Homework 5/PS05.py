...
print('The variance of log productivity in the random sample is', round(var_sam_z,2), 'compared to', round(var_pop_z,2), 'in the data.')
...
for i in range(reps):
    ...
    for j in range(nsample):
        k_e_sam[j] = kstartsam*ssam[j]/ssam[0]
    gains_sam = 100*(Y(k_e_sam)/Y(ksam)-1)
