...
# Calculating and plotting the errors for the Ramp function using evenly spaced nodes and monomials
...
five, = plt.plot(polys[1], label='Degree 5')
ten, = plt.plot(polys[2], label='Degree 10')
exp_real, = plt.plot(real_f, label ='exp(1/x)')
plt.title('The exponential function with evenly spaced nodes')
plt.legend(handles = [cubic, five, ten, exp_real], loc='upper left')
plt.show()

# Calculating and plotting the errors for the Exponential function using evenly spaced nodes and monomials
errors3 = abs(real_f - polys[0])
errors5 = abs(real_f - polys[1])
errors10 = abs(real_f - polys[2])
er3, = plt.plot(errors3, label = 'Cubic')
er5, = plt.plot(errors5, label ='Monomial 5')
er10, = plt.plot(errors10, label ='Monomial 10')
plt.title('Errors Expo, Evenly spaced, Cubic and Monomials')
plt.legend(handles = [er3, er5, er10], loc='upper left')
plt.show()
...
five, = plt.plot(polys[1], label='Degree 5')
ten, = plt.plot(polys[2], label='Degree 10')
rud_real, = plt.plot(real_g, label ='exp(1/x)')
plt.title('The Runge function with evenly spaced nodes')
plt.legend(handles = [cubic, five, ten, rud_real], loc='upper left')
plt.show()

# Calculating and plotting the errors for the Runge function using evenly spaced nodes and monomials
...
ten, = plt.plot(polys[2], label='Degree 10')
ramp_real, = plt.plot(real_h, label ='ramp(x)')
plt.title('Ramp function, Chebychev nodes, monomials')
plt.legend(handles = [cubic, five, ten, ramp_real], loc='upper left')
plt.show()

# Calculating and plotting the errors for the Ramp function using Cheby nodes and monomials
errors3 = abs(real_h - polys[0])
errors5 = abs(real_h - polys[1])
errors10 = abs(real_h - polys[2])
er3, = plt.plot(errors3, label = 'Cubic')
...
ten, = plt.plot(polys[2], label='Degree 10')
exp_real, = plt.plot(real_f, label ='exp(1/x)')
plt.title('The exponential function, Chebychev nodes, monomials')
plt.legend(handles = [cubic, five, ten, exp_real], loc='upper left')
plt.show()
...
er5, = plt.plot(errors5, label ='Monomial 5')
er10, = plt.plot(errors10, label ='Monomial 10')
plt.title('Errors Expo, Cheby Nodes, Cubic and Monomials')
plt.legend(handles = [er3, er5, er10], loc='upper left')
plt.show()
...
five, = plt.plot(polys[1], label='Degree 5')
ten, = plt.plot(polys[2], label='Degree 10')
rung_real, = plt.plot(real_g, label ='Runge')
plt.title('The Runge function, Chebychev nodes, monomials')
plt.legend(handles = [cubic, five, ten, rung_real], loc='upper left')
plt.show()
...
# Error plots Cheby node and polys for ramp function
...
i = 3
m = 4
ch_app_3 = cheby_approx(i,f,x_grid,a,b,m)
i = 5
m = 6
ch_app_5 = cheby_approx(i,f,x_grid,a,b,m)
i = 10
m = 11
ch_app_10 = cheby_approx(i,f,x_grid,a,b,m)
app3, = plt.plot(ch_app_3, label = 'Cubic Chevy')
app5, = plt.plot(ch_app_5, label = '5 Chevy')
app10, = plt.plot(ch_app_10, label = '10 Chevy')
realr, = plt.plot(real_exp,label = 'Exp')
plt.title('Exp function, Cheby nodes, Cheby polys')
plt.legend(handles = [app3, app5, app10, realr], loc='upper left')
plt.show()

# Error plots Cheby node and polys for exp function
errors3 = abs(real_f - ch_app_3)
errors5 = abs(real_f - ch_app_5)
errors10 = abs(real_f - ch_app_10)
er3, = plt.plot(errors3, label = 'Chevy Cubic')
er5, = plt.plot(errors5, label ='Chevy 5')
er10, = plt.plot(errors10, label ='Chevy 10')
plt.title('Errors Exp, Cheby Nodes, Chevy Polys')
plt.legend(handles = [er3, er5, er10], loc='upper left')
plt.show()
...
# Error plots Cheby node and polys for Runge function
